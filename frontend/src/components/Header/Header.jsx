...
//   // Array of text for each slider image
//   const sliderText = [
//     { heading: "Welcome to SwiftOrder", content: "Explore our eclectic menu featuring a mouthwatering selection of dishes, each meticulously crafted with premium ingredients. Embark on a culinary adventure and elevate your dining experience with every delightful bite." },
//     { heading: "Discover Our Specialties", content: "Indulge in a world of flavors with our signature dishes, each created to tantalize your taste buds and leave you craving for more. From traditional favorites to innovative creations, there's something for everyone at SwiftOrder." },
//     // Add more objects for additional slider text
//     { heading: "Lorem Ipsum", content: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla condimentum augue a tellus vulputate, id hendrerit est pharetra." },
//     // Add more objects for additional slider text
//   ];
...
//         <h2>{sliderText[currentImage].heading}</h2>
//         <p>{sliderText[currentImage].content}</p>
